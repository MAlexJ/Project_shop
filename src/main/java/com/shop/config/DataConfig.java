...
public class DataConfig {
    ...
    //TODO We will use Spring 4, Hibernate 4 as a JPA provider, BoneCP for connection pool,
    // PostgreSQL driver (I was using PostgreSQL database, you can use whatever you want),
    // Jackson JSON mapper which converts Java objects to JSON.
    // https://www.thenewboston.com/forum/topic.php?id=6808
